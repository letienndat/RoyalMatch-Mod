...
namespace Unity
{
    ...
    namespace Component
    {
        void Initialize()
        {
            IL2CPP_Resolver::SystemTypeCache::Initializer::Add(UNITY_COMPONENT_CLASS);

            m_ComponentFunctions.m_GetGameObject    = IL2CPP_Resolver::ResolveCall(UNITY_COMPONENT_GETGAMEOBJECT);
            m_ComponentFunctions.m_GetTransform        = IL2CPP_Resolver::ResolveCall(UNITY_COMPONENT_GETTRANSFORM);
        }
    }
}
