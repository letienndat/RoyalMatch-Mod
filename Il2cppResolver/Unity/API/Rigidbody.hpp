...
namespace Unity
{
    ...
    class CRigidbody : public IL2CPP_Resolver::CClass
    {
    public:
    ...
    namespace RigidBody
    {
        void Initialize()
        {
            IL2CPP_Resolver::SystemTypeCache::Initializer::Add(UNITY_RIGIDBODY_CLASS);

            m_RigidbodyFunctions.m_GetDetectCollisions    = IL2CPP_Resolver::ResolveCall(UNITY_RIGIDBODY_GETDETECTCOLLISIONS);
            m_RigidbodyFunctions.m_GetVelocity            = IL2CPP_Resolver::ResolveCall(UNITY_RIGIDBODY_GETVELOCITY);
            m_RigidbodyFunctions.m_SetDetectCollisions    = IL2CPP_Resolver::ResolveCall(UNITY_RIGIDBODY_SETDETECTCOLLISIONS);
            m_RigidbodyFunctions.m_SetVelocity            = IL2CPP_Resolver::ResolveCall(UNITY_RIGIDBODY_SETVELOCITY);
