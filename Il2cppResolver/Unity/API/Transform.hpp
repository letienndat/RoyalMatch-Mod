...
namespace Unity
{
    ...
    class CTransform : public IL2CPP_Resolver::CClass
    {
    public:
        ...
        {
            return reinterpret_cast<CTransform * (UNITY_CALLING_CONVENTION)(void*, System_String*, bool)>(m_TransformFunctions.m_FindChild)(this, IL2CPP_Resolver::String::New(path), isActiveOnly);
        }
        ...
        {
            Vector3 vRet;
            vRet = reinterpret_cast<Vector3(UNITY_CALLING_CONVENTION)(void*)>(m_TransformFunctions.m_GetForward)(this);
            return vRet;
        }
        ...
        {
            reinterpret_cast<void(UNITY_CALLING_CONVENTION)(void*, Vector3)>(m_TransformFunctions.m_SetForward)(this, m_vVector);
        }
    ...
    namespace Transform
    {
        void Initialize()
        {
            IL2CPP_Resolver::SystemTypeCache::Initializer::Add(UNITY_TRANSFORM_CLASS);
                
            m_TransformFunctions.m_GetParent        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETPARENT);
            m_TransformFunctions.m_GetRoot            = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETROOT);
            m_TransformFunctions.m_GetChild            = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETCHILD);
            m_TransformFunctions.m_GetChildCount    = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETCHILDCOUNT);
            m_TransformFunctions.m_FindChild        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_FINDCHILD);
            m_TransformFunctions.m_GetPosition        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETPOSITION);
            m_TransformFunctions.m_GetForward        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETFORWARD);
            m_TransformFunctions.m_GetRotation        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETROTATION);
            m_TransformFunctions.m_GetLocalPosition = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETLOCALPOSITION);
            m_TransformFunctions.m_GetLocalScale    = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_GETLOCALSCALE);
            m_TransformFunctions.m_SetPosition        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_SETPOSITION);
            m_TransformFunctions.m_SetForward        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_SETFORWARD);
            m_TransformFunctions.m_SetRotation        = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_SETROTATION);
            m_TransformFunctions.m_SetLocalPosition = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_SETLOCALPOSITION);
            m_TransformFunctions.m_SetLocalScale    = IL2CPP_Resolver::ResolveCall(UNITY_TRANSFORM_SETLOCALSCALE);
        }
    }
}
