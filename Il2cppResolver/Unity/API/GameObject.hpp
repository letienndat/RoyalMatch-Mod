...
namespace Unity
{
    ...
    public:
        ...
        {
            return reinterpret_cast<CComponent*(UNITY_CALLING_CONVENTION)(void*, System_String*)>(m_GameObjectFunctions.m_GetComponent)(this, IL2CPP_Resolver::String::New(m_pName));
        }
        ...
        {
            il2cppClass* m_pClass = IL2CPP_Resolver::Class::Find(type);
            if (!m_pClass) return nullptr;

            return GetComponentInChildren(IL2CPP_Resolver::Class::GetSystemType(m_pClass), true);
        }
        ...
        {
            il2cppClass* m_pClass = IL2CPP_Resolver::Class::Find(m_pSystemTypeName);
            if (!m_pClass) return nullptr;

            return GetComponents(IL2CPP_Resolver::Class::GetSystemType(m_pClass));
        }
        ...
        CComponent* GetComponentByIndex(const char* m_pSystemTypeName, unsigned int m_uIndex = 0U)
        {
            ...
            return GetComponentByIndex(IL2CPP_Resolver::Class::GetSystemType(m_pClass), m_uIndex);
        }
    ...
    namespace GameObject
    {
        ...
        void Initialize()
        {
            IL2CPP_Resolver::SystemTypeCache::Initializer::Add(UNITY_GAMEOBJECT_CLASS);

            m_GameObjectFunctions.m_AddComponent            = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_ADDCOMPONENT);
            m_GameObjectFunctions.m_CreatePrimitive            = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_CREATEPRIMITIVE);
            m_GameObjectFunctions.m_Find                    = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_FIND);
            m_GameObjectFunctions.m_FindGameObjectsWithTag    = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_FINDGAMEOBJECTWITHTAG);
            m_GameObjectFunctions.m_GetComponent            = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_GETCOMPONENT);
            m_GameObjectFunctions.m_GetComponents            = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_GETCOMPONENTS);
            m_GameObjectFunctions.m_GetComponentInChildren    = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_GETCOMPONENTINCHILDREN);
            m_GameObjectFunctions.m_GetActive                = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_GETACTIVE);
            m_GameObjectFunctions.m_GetLayer                = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_GETLAYER);
            m_GameObjectFunctions.m_GetTransform            = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_GETTRANSFORM);
            m_GameObjectFunctions.m_SetActive                = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_SETACTIVE);
            m_GameObjectFunctions.m_SetLayer                = IL2CPP_Resolver::ResolveCall(UNITY_GAMEOBJECT_SETLAYER);
        }
        ...
        {
            return reinterpret_cast<CGameObject*(UNITY_CALLING_CONVENTION)(System_String*)>(m_GameObjectFunctions.m_Find)(IL2CPP_Resolver::String::New(m_Name));
        }

        il2cppArray<CGameObject*>* FindWithTag(const char* m_Tag)
        {
            return reinterpret_cast<il2cppArray<CGameObject*>*(UNITY_CALLING_CONVENTION)(void*)>(m_GameObjectFunctions.m_FindGameObjectsWithTag)(IL2CPP_Resolver::String::New(m_Tag));
        }
    }
}
