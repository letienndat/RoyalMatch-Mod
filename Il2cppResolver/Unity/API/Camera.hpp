...
namespace Unity
{
    ...
    namespace Camera
    {
        void Initialize()
        {
            IL2CPP_Resolver::SystemTypeCache::Initializer::Add(UNITY_CAMERA_CLASS);

            m_CameraFunctions.m_GetCurrent        = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_GETCURRENT);
            m_CameraFunctions.m_GetMain            = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_GETMAIN);
            m_CameraFunctions.m_GetDepth        = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_GETDEPTH);
            m_CameraFunctions.m_SetDepth        = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_SETDEPTH);
            m_CameraFunctions.m_GetFieldOfView    = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_GETFIELDOFVIEW);
            m_CameraFunctions.m_SetFieldOfView    = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_SETFIELDOFVIEW);
            m_CameraFunctions.m_WorldToScreen    = IL2CPP_Resolver::ResolveCall(UNITY_CAMERA_WORLDTOSCREEN);
        }
