...
//#define IL2CPP_ASSERT(x) assert(0)
    ...
    #include <cassert>
    #define IL2CPP_ASSERT(x) ((void)0) // Replace assert(x) to void(0)
#endif

#ifndef IL2CPP_RESOLVER_LOG
#define IL2CPP_RESOLVER_LOG(fmt, ...) NSLog(@"[IL2CPP_RESOLVER] " fmt "\n", ##__VA_ARGS__)
#endif
    ...
    namespace UnityAPI
    {
        ...
        bool Initialize()
        {
            ...
            std::unordered_map<const char*, void**> m_ExportMap =
            {
                ...
                { IL2CPP_CLASS_GET_FIELD_OFFSET_EXPORT,            &Functions.m_ClassGetFieldOffset },
...
//                { IL2CPP_THREAD_GET_NAME_EXPORT,                        &Functions.m_ThreadGetName },
            ...
            // Caches
            IL2CPP_Resolver::SystemTypeCache::Initializer::PreCache();
