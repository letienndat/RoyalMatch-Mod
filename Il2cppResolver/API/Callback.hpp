...
namespace IL2CPP_Resolver
{
	...
	namespace Callback
	{
		...
		void Initialize()
		{
			void* m_IL2CPPThread = Thread::Attach(IL2CPP_Resolver::Domain::Get());

			// Find
			void** m_MonoBehaviourVTable = *reinterpret_cast<void***>(IL2CPP_Resolver::Helper::GetMonoBehaviour()->m_CachedPtr);
			...
			IL2CPP_Resolver::Thread::Detach(m_IL2CPPThread);
