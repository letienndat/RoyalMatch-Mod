...
namespace IL2CPP_Resolver
{
    namespace Helper
    {
        ...
        {
            auto il2cppClass = IL2CPP_Resolver::Class::Find(className.c_str());
            if (!il2cppClass)
            {
            ...
            uint64_t methodPointer = IL2CPP_Resolver::Class::Utils::GetMethodPointerRVA(il2cppClass, methodName.c_str(), sizeof...(args));
            if (!methodPointer)
            {
        ...
        T GetStaticFieldValue(const std::string &className, const std::string &fieldName)
        {
            ...
            void *value = IL2CPP_Resolver::Class::Utils::GetStaticField(il2cppClass, fieldName.c_str());
            if (!value)
            {
        ...
        void SetStaticFieldValue(const std::string &className, const std::string &fieldName, const T &value)
        {
            ...
            IL2CPP_Resolver::Class::Utils::SetStaticField(il2cppClass, fieldName.c_str(), (void *)&value);
        }
        ...
        T GetPropertyValue(Unity::CGameObject *obj, const std::string &className, const std::string &propertyName)
        {
            ...
            return reinterpret_cast<T (*)(void *)>(IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, ("get_" + propertyName).c_str()))(instance);
        }
        ...
        void SetPropertyValue(Unity::CGameObject *obj, const std::string &className, const std::string &propertyName, const T &value)
        {
            ...
            reinterpret_cast<void (*)(void *, T)>(IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, ("set_" + propertyName).c_str()))(instance, value);
        }

        Unity::CGameObject *CloneGameObject(Unity::CGameObject *obj, const Unity::Vector3 &position)
        {
            auto il2cppClass = IL2CPP_Resolver::Class::Find("UnityEngine.Object");
            if (!il2cppClass)
            {
            ...
            void *instantiateMethod = IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, "Instantiate", 1);
        ...
        Ret CreateInstanceAndInvoke(const std::string &className, const std::string &ctorName, const std::string &methodName, Args... ctorArgs)
        {
            ...
            void *ctorPointer = IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, ctorName.c_str(), sizeof...(ctorArgs));
            if (!ctorPointer)
            {
            ...
            void *methodPointer = IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, methodName.c_str(), 0);
            if (!methodPointer)
            {
                std::cerr << "Method " << methodName << " not found in class " << className << ".\n";
                return Ret();
        ...
        void PrintInstanceFields(Unity::il2cppObject *instance, const std::string &className)
        {
            ...
            IL2CPP_Resolver::Class::FetchFields(il2cppClass, &fields);
        ...
        Ret InvokeMethodByDelegate(Unity::CGameObject *obj, const std::string &className, const std::string &methodName, Args... args)
        {
            ...
            void *methodPointer = IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, methodName.c_str(), sizeof...(args));
            if (!methodPointer)
            {
                std::cerr << "Method " << methodName << " not found in class " << className << ".\n";
                return Ret();
        ...
        Ret InvokeMethodOnComponent(Unity::CGameObject *obj, const std::string &componentName, const std::string &methodName, Args... args)
        {
            ...
            auto il2cppClass = IL2CPP_Resolver::Class::Find(componentName.c_str());
            if (!il2cppClass)
            {
        ...
        Unity::CGameObject *CreateInstance(const std::string &className)
        {
            ...
            void *createInstanceMethod = IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, "Instantiate", 1);
        ...
        void InvokeMethodOnTaggedGameObjects(const std::string &tag, const std::string &className, const std::string &methodName, Args... args)
        {
            ...
            void *methodPointer = IL2CPP_Resolver::Class::Utils::GetMethodPointer(il2cppClass, methodName.c_str());
            if (!methodPointer)
            {
                std::cerr << "Method " << methodName << " not found in class " << className << ".\n";
                return;
